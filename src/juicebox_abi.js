export const jb_abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        components: [
          { internalType: "bool", name: "preferUnstaked", type: "bool" },
          { internalType: "uint16", name: "percent", type: "uint16" },
          { internalType: "uint48", name: "lockedUntil", type: "uint48" },
          {
            internalType: "address payable",
            name: "beneficiary",
            type: "address",
          ...
          { internalType: "uint56", name: "projectId", type: "uint56" },
        ],
        indexed: false,
    ...
    inputs: [
      { internalType: "uint256", name: "_projectId", type: "uint256" },
      {
        components: [
          ...
          { internalType: "uint256", name: "cycleLimit", type: "uint256" },
          {
            internalType: "uint256",
            name: "discountRate",
            type: "uint256",
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "overflow", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "_handle", type: "bytes32" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_projectId", type: "uint256" },
      { internalType: "contract ITerminal", name: "_to", type: "address" },
    ],
    name: "migrate",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "contract ITerminal", name: "", type: "address" }],
  ...
  },
  {
    ...
    name: "modStore",
    outputs: [
      { internalType: "contract IModStore", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [],
    name: "prices",
    outputs: [{ internalType: "contract IPrices", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    name: "projects",
    outputs: [
      { internalType: "contract IProjects", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_projectId", type: "uint256" },
      { internalType: "uint256", name: "_count", type: "uint256" },
      { internalType: "uint256", name: "_minReturnedWei", type: "uint256" },
      {
        internalType: "address payable",
        name: "_beneficiary",
        type: "address",
      },
      { internalType: "bool", name: "_preferUnstaked", type: "bool" },
    ],
    name: "redeem",
    outputs: [{ internalType: "uint256", name: "amount", type: "uint256" }],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "ticketBooth",
    outputs: [
      { internalType: "contract ITicketBooth", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
