    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li2, "class", "svelte-1v2qed4");
    			...
    			attr_dev(li3, "class", "svelte-1v2qed4");
    			add_location(li3, file$2, 5, 2, 355);
    			attr_dev(ul, "class", "svelte-1v2qed4");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img1, "class", "svelte-1y8grua");
    			add_location(img1, file, 24, 4, 670);
    			attr_dev(section, "id", "main-description");
    			attr_dev(section, "class", "svelte-1y8grua");
