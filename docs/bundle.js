    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$1, 1, 2, 11);
    			add_location(h1, file$1, 2, 2, 47);
    			...
    			add_location(img1, file$1, 4, 2, 144);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file, 22, 2, 562);
